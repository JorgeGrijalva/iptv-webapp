...
export function useVodUrl(vodId: number, extension: string) {
  ...
  return `${proxyUrl}/movie/${accountInfo.user_info?.username}/${accountInfo.user_info?.password}/${vodId}.${extension}`
}
...
export function useEpisodeUrl(episodeStreamId: number, extension: string) {
  ...
  return `${proxyUrl}/series/${accountInfo.user_info?.username}/${accountInfo.user_info?.password}/${episodeStreamId}.${extension}`
}
